...
Redis quick start -> https://redis.io/docs/latest/integrate/redisom-for-python/
Redis client interface -> https://redis.io/docs/latest/develop/connect/cli/
Redis client for Node JS -> https://redis.io/docs/latest/develop/connect/cli/
Kue deprecated but still use in the industry -> https://github.com/redis/node-redis?tab=readme-ov-file
Learning Objectives -> https://github.com/Automattic/kue
...
6. Create the Job creatorIn a file named 6-job_creator.js:
